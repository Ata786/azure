        ...
        child: Column(children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                textWidget(text: "Region Name", fontSize: FetchPixels.getPixelHeight(15), fontWeight: FontWeight.w600,textColor: Colors.black),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        textWidget(text: "${regionWiseList[index].regionName}", fontSize: FetchPixels.getPixelHeight(15), fontWeight: FontWeight.w500,textColor: Colors.black),
                        textWidget(text: value == "Tonnage" ? "${formatNumberWithCommas(regionWiseList[index].totalValue.toString())}" : "${formatNumberWithCommas(regionWiseList[index].totalValue!.toStringAsFixed(0))}", fontSize: FetchPixels.getPixelHeight(15), fontWeight: FontWeight.w500,textColor: Colors.black)
                      ],
                    ),
                  ),
                  SizedBox(height: FetchPixels.getPixelHeight(10),),
