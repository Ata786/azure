        ...
        child: Column(children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                textWidget(text: "Brand Name", fontSize: FetchPixels.getPixelHeight(15), fontWeight: FontWeight.w600,textColor: Colors.black),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        textWidget(text: "${brandWiseList[index].brandName}", fontSize: FetchPixels.getPixelHeight(15), fontWeight: FontWeight.w500,textColor: Colors.black),
                        textWidget(text: value == "Tonnage" ? "${formatNumberWithCommas(brandWiseList[index].totalTonage.toString())}" : "${formatNumberWithCommas(brandWiseList[index].totalTonage!.toStringAsFixed(0))}", fontSize: FetchPixels.getPixelHeight(15), fontWeight: FontWeight.w500,textColor: Colors.black)
                      ],
                    ),
                  ),
                  SizedBox(height: FetchPixels.getPixelHeight(10),),
