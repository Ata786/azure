        ...
        builder: (context) =>
            AlertDialog(
                content: Container(
                  ...
                  child: Column(
                    children: [
                      Text('Select Image',style: TextStyle(fontSize: (myHeight/4)/10,fontWeight: FontWeight.bold,fontFamily: 'segoe'),),
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(color: themeColor,
                              boxShadow: [BoxShadow(offset: Offset(0,3), color:Colors.grey.withOpacity(0.5), blurRadius: 1,spreadRadius: 1)],
                      ...
                      //         boxShadow: [BoxShadow(offset: Offset(0,3), color:themeColor, blurRadius: 1, spreadRadius: 1)],
                      //         borderRadius: BorderRadius.all(Radius.circular(((myHeight/4)/4)/10))),
