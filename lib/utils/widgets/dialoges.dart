...
void showSyncUpDialog({required onTap}){
  Get.dialog(
      AlertDialog(content: Container(height: FetchPixels.getPixelHeight(155),width: FetchPixels.width/1.5,color: Colors.white,
        child: Padding(
          padding: EdgeInsets.symmetric(horizontal: FetchPixels.getPixelWidth(10)),
          child: Column(
            children: [
              Icon(Icons.info_outline,color: Colors.black,),
              SizedBox(height: FetchPixels.getPixelHeight(10),),
              textWidget(text: "Confirm Sync Up", fontSize: FetchPixels.getPixelHeight(15), fontWeight: FontWeight.bold,textColor: Colors.black),
              SizedBox(height: FetchPixels.getPixelHeight(10),),
              textWidget(text: "Are you sure you want to Sync Up the data?", fontSize: FetchPixels.getPixelHeight(12), fontWeight: FontWeight.w400,textColor: Colors.black),
              SizedBox(height: FetchPixels.getPixelHeight(10),),
              Container(height: FetchPixels.getPixelHeight(1),width: FetchPixels.width,color: Colors.black,),
              SizedBox(height: FetchPixels.getPixelHeight(10),),
              Row(
